<template>
    <div class="project-page">
      ...
      <section class="container project-container mx-auto -mt-48">
        <div class="flex mt-3">
          <div class="w-3/4 mr-6">
            <div class="bg-white p-3 mb-3 border-4 border-gray-bg shadow-bg rounded-20">
            ...
            <div class="flex -mx-2">
              <div
                class="relative w-1/4 bg-white m-2 p-2 border-2 border-gray-300 hover:shadow-bg rounded-20"
              >
          ...
          <div class="w-1/4">
            <div
              class="bg-white w-full p-5 border-4 shadow-bg border-gray-bg rounded-20 sticky"
              style="top: 15px"
            >
              ...
              <div class="flex mt-3">
                ...
                <div class="w-3/4 ml-5 mt-1">
                  <div class="font-semibold text-xl text-black-font">
                    Julia Keeva
                  </div>
              ...
              <input
                type="number"
                class="border border-gray-300 block w-full px-6 py-3 mt-4 rounded-full text-gray-800 transition duration-300 ease-in-out focus:outline-none focus:shadow-outline"
                placeholder="Amount in Rp"
                value=""
              />
              <nuxt-link
                to="/fund-success"
                class="text-center mt-3 button-cta block w-full bg-purple-progress hover:bg-green-button text-white font-medium px-6 py-3 text-md rounded-full"
              >
                Fund Now
              </nuxt-link>
            </div>
